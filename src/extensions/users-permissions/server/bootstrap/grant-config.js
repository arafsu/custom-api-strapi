...
module.exports = baseURL => ({
  ...
  keycloak: {
    ...
    secret: '',
    oauth: 2,
    authorize_url: 'http://localhost:8081/auth/realms/custom-strapi-provider/protocol/openid-connect/auth',
    access_url: 'http://localhost:8081/auth/realms/custom-strapi-provider/protocol/openid-connect/token',
    callback: `http://localhost:1330/api/auth/keycloak/callback`,
    scope: ['openid']
  }
});
